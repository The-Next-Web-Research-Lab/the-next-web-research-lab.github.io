import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as r,c as l,a as n,b as s,d as a,e as i}from"./app-89a3734e.js";const u={},d=n("h1",{id:"cleanly-branch-browsers-with-client-hints",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#cleanly-branch-browsers-with-client-hints","aria-hidden":"true"},"#"),s(" Cleanly branch browsers with Client Hints")],-1),c=n("h2",{id:"the-problem-with-user-agent",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#the-problem-with-user-agent","aria-hidden":"true"},"#"),s(" The problem with User-Agent")],-1),p={href:"https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/User-Agent",target:"_blank",rel:"noopener noreferrer"},v=n("code",null,"window.navigator.userAgent",-1),m=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// Chrome
