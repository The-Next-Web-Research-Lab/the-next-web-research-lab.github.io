import{_ as n,o as s,c as a,e as p}from"./app-0e85ea10.js";const t={},e=p(`<h2 id="c3-adaptor" tabindex="-1"><a class="header-anchor" href="#c3-adaptor" aria-hidden="true">#</a> c3-adaptor</h2><h3 id="config-js" tabindex="-1"><a class="header-anchor" href="#config-js" aria-hidden="true">#</a> config.js</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token constant">CHART_OPTION</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
