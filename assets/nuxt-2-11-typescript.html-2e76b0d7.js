import{_ as n,o as s,c as a,e}from"./app-4abeeaf4.js";const t={},p=e(`<h1 id="nuxt-v2-11-기반-nuxt-typescript-환경-세팅" tabindex="-1"><a class="header-anchor" href="#nuxt-v2-11-기반-nuxt-typescript-환경-세팅" aria-hidden="true">#</a> Nuxt v2.11 기반 nuxt/typescript 환경 세팅</h1><h3 id="설치" tabindex="-1"><a class="header-anchor" href="#설치" aria-hidden="true">#</a> 설치</h3><p>설치 순서는 다음과 같다.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> npx <span class="token comment"># npx 설치. create-nuxt-app을 설치하기 위함.</span>
