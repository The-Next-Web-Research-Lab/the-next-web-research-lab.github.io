...
<h1 id="gof-디자인-패턴-행동패턴" tabindex="-1"><a class="header-anchor" href="#gof-디자인-패턴-행동패턴" aria-hidden="true">#</a> GoF 디자인 패턴 | 행동패턴</h1>
<ul>
...
<h2 id="책임연쇄-chain-of-responsibility" tabindex="-1"><a class="header-anchor" href="#책임연쇄-chain-of-responsibility" aria-hidden="true">#</a> 책임연쇄(Chain of responsibility)</h2>
<h3 id="의도" tabindex="-1"><a class="header-anchor" href="#의도" aria-hidden="true">#</a> 의도</h3>
<p>메세지를 보내는 객체와 이를 받아 처리하는 객체들 간의 결합도를 없애기 위한 패턴입니다.
하나의 요청에 대한 처리가 반드시 한 객체에서만 되지 않고, 여러 객체에게 그 처리 기회를 주려는 것입니다.</p>
<h3 id="활용성" tabindex="-1"><a class="header-anchor" href="#활용성" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>하나 이상의 객체가 요청을 처리해야 하고, 그 요청 처리자중 어떤 것이 선행자인지 모를 때, 처리자가 자동으로 확정되어야 합니다.</li>
<li>메시지를 받을 객체를 명시하지 않은 채 여러 객체 중 하나에게 처리를 요청하고 싶을 때</li>
<li>요청을 처리할 수 있는 객체 집합이 동적으로 정의되어야 할 때</li>
</ul>
<h3 id="구조-및-구현" tabindex="-1"><a class="header-anchor" href="#구조-및-구현" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Handler</span> <span class="token punctuation">{</span>
...
<p>사용자는 처리를 요청하고, 이 처리 요청을 실제로 그 요청을 받을 책임이 있는 <code v-pre>ConcreteHandler</code>객체를 만날 때까지 정의된 연결고리를 따라서 계속 전달됩니다.</p>
<h3 id="결과" tabindex="-1"><a class="header-anchor" href="#결과" aria-hidden="true">#</a> 결과</h3>
<ol>
<li>객체 간의 행동적 결합도가 적어집니다.</li>
<li>객체에게 책임을 할당하는 데 유연성을 높일 수 있습니다.</li>
<li>메시지 수신이 보장되지는 않습니다.
<ul>
<li>어떤 객체가 이 처리에 대한 수신을 담당한다는 것을 명시하지 않으므로 요청이 처리된다는 보장이 없습니다.</li>
</ul>
</li>
</ol>
<h2 id="명령-command" tabindex="-1"><a class="header-anchor" href="#명령-command" aria-hidden="true">#</a> 명령(Command)</h2>
<h3 id="의도-1" tabindex="-1"><a class="header-anchor" href="#의도-1" aria-hidden="true">#</a> 의도</h3>
<p>요청 자체를 캡슐화하는 것입니다. 이를 통해 요청이 서로 다른 사용자를 매개변수로 만들고, 요청을 대기 시키거나 로깅하여, 되돌릴 수 있는 연산을 지원합니다.</p>
<h3 id="활용성-1" tabindex="-1"><a class="header-anchor" href="#활용성-1" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>수행할 동작을 객체로 매개변수화하고자 할 때
<ul>
<li>절차지향 프로그래밍에서는 이를 콜백 함수, 즉 어딘가 등록되었다가 나중에 호출되는 함수를 사용해서 이러한 매개변수화를 표현할 수 있다.</li>
<li>명령 패턴은 콜백을 객체지향 방식으로 나타낸 것이다.</li>
</ul>
</li>
<li>서로 다른 시간에 요청을 명시하고, 저장하며, 실행하고 싶을 때.</li>
<li>실행 취소 기능을 지원하고 싶을 때.
<ul>
<li>Command의 execute() 연산은 상태를 저장할 수 있는 데, 이를 이용해서 지금까지 얻은 결과를 바꿀 수 있다.</li>
<li>이를 위해 unexecute() 연산을 Command 클래스의 인터페이스에 추가한다.</li>
</ul>
</li>
<li>시스템이 고장 났을 때 재적용이 가능하도록 변경 과정에 대한 로깅을 지원하고 싶을 때.
<ul>
<li>Command 인터페이스를 확장해서 load()와 store()연산을 정의하면 상태의 변화를 지속적(persistant) 저장소에 저장해 둘 수 있다.</li>
</ul>
</li>
<li>기본적인 연산의 조합으로 만든 상위 수준 연산을 써서 시스템을 구조화하고 싶을 때.
<ul>
<li>일련의 과정을 통해 데이터를 변경하는 트랜젝션(transaction)의 모델링을 가능하게 한다.</li>
</ul>
</li>
</ul>
<h3 id="구조-및-구현-1" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-1" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Command</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="해석자-interpreter" tabindex="-1"><a class="header-anchor" href="#해석자-interpreter" aria-hidden="true">#</a> 해석자(Interpreter)</h2>
<h3 id="의도-2" tabindex="-1"><a class="header-anchor" href="#의도-2" aria-hidden="true">#</a> 의도</h3>
<p>간단한 언어의 문법을 정의하는 방법과 그 언어로 문장을 구정하는 방법, 이들 문장을 해석하는 방법을 설명합니다.</p>
<h3 id="활용성-2" tabindex="-1"><a class="header-anchor" href="#활용성-2" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>정의할 언어의 문법이 간단할 때 적합하다.</li>
<li>문법이 복잡하다면 문법을 정의하는 클래스 계통이 복잡해지고 관리하기 힘들기 때문에 이럴 때는 파서 생성기가 적합하다.</li>
</ul>
<h3 id="해석자-정의-방법" tabindex="-1"><a class="header-anchor" href="#해석자-정의-방법" aria-hidden="true">#</a> 해석자 정의 방법</h3>
<ol>
<li>문법정의
<ul>
<li>expression: 시작 기호</li>
<li>literal: 터미널 기호</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>expression ::= literal | alternation | sequence | repetition | '(' expression ')'
alternation ::= expression '|' expression
sequence ::= expression '&amp;' expression
repetition ::= expression '*'
literal ::= 'a' | 'b' | 'c' ... {'a' | 'b' | 'c'...}*
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>문법 오른편을 클래스로 정의</li>
<li>interpret(context) 연산을 구현하여 Context를 근거로 입력문자열에서 다음번 일치하는 문자열을 발견한다.
<ul>
<li>Context는 입력 문자열이 무엇이고 지금까지 어떻게 일치되는 내용을 찾아왔는지에 대한 상태 정보를 포함한다.</li>
</ul>
</li>
<li>결과적으로 interpret(context)에서 클래스들을 사용함으로 트리 형태로 만들어진다.</li>
</ol>
<h3 id="구조-및-구현-2" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-2" aria-hidden="true">#</a> 구조 및 구현</h3>
<blockquote>
<p>작성중</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">AbstractExpression</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">TerminalExpression</span> <span class="token keyword">implements</span> <span class="token class-name">AbstractExpression</span> <span class="token punctuation">{</span>
    <span class="token function">interpret</span><span class="token punctuation">(</span>context<span class="token operator">:</span> Context<span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="반복자-iterator" tabindex="-1"><a class="header-anchor" href="#반복자-iterator" aria-hidden="true">#</a> 반복자(Iterator)</h2>
<h3 id="의도-3" tabindex="-1"><a class="header-anchor" href="#의도-3" aria-hidden="true">#</a> 의도</h3>
<p>내부 표현부를 노출하지 않고 어떤 집합 객체에 속한 원소들을 순차적으로 접근할 수 있는 방법을 제공합니다.</p>
...
<li>집합 객체를 순회하는 다양한 방법을 지원하고 싶을 때
<ul>
<li>트리를 순회할 때 중위 순회 방식이나 전위 순회 방식등과 같은 순회 알고리즘을 바꿀 수 있다.</li>
</ul>
</li>
...
<blockquote>
<p>Cursor: Aggregate 클래스에서 순회 알고리즘을 정의하고, Iterator에는 순회의 상태만 저장할 수 있는 데,
이렇게 구현된 Iterator를 Cursor라고 가리킨다.</p>
</blockquote>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Aggregate</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="중재자-mediator" tabindex="-1"><a class="header-anchor" href="#중재자-mediator" aria-hidden="true">#</a> 중재자(Mediator)</h2>
<h3 id="의도-4" tabindex="-1"><a class="header-anchor" href="#의도-4" aria-hidden="true">#</a> 의도</h3>
<p>한 집합에 속해 있는 객체의 상호작용을 캡슐화하는 객체를 정의합니다.
객체들이 서로를 직접 참조하지 않도록 하여 객체들간의 소결합(Loose Coupling)을 촉진시키며,
객체들 간의 상호작용을 독립적으로 다양화 시킬 수 있게 합니다.</p>
<h3 id="활용성-4" tabindex="-1"><a class="header-anchor" href="#활용성-4" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>한 객체가 다른 객체를 너무 많이 참고하고, 너무 많은 의사소통을 수행해서 그 객체를 재사용하기 힘들 때</li>
<li>여러 클래스에 분산된 행동들이 상속없이 상황에 맞게 수정되어야 할 때</li>
<li>여러 객체가 잘 정의된 형태이기는 하지만 복잡한 상호작용을 가질 때</li>
<li>객체간의 의존성이 구조화되지 않으며, 잘 이해하기 어려울 때</li>
</ul>
<h3 id="구조-및-구현-4" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-4" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Mediator</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">ConcreteColleague2</span> <span class="token keyword">implements</span> <span class="token class-name">Colleague</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="협력방법" tabindex="-1"><a class="header-anchor" href="#협력방법" aria-hidden="true">#</a> 협력방법</h4>
<ul>
<li>Colleague는 Mediator에서 요청을 송수신합니다.</li>
<li>Mediator는 필요한 Colleague 사이에 요청을 전달할 의무가 있습니다.</li>
</ul>
<h4 id="사용자측-코드-3" tabindex="-1"><a class="header-anchor" href="#사용자측-코드-3" aria-hidden="true">#</a> 사용자측 코드</h4>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<ul>
<li>어떤 객체의 상태에 대한 스냅샷을 저장한 후 나중에 이 상태로 복구해야 할 때</li>
<li>상태를 얻는 데 필요한 직접적인 인터페이스를 두면 그 객체의 구현 세부사항에 드러날 수 밖에 없고,
이것으로 객체의 캡슐화가 깨질때</li>
</ul>
<h3 id="구조-및-구현-5" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-5" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Memento</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Caretaker</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="감시자-observer" tabindex="-1"><a class="header-anchor" href="#감시자-observer" aria-hidden="true">#</a> 감시자(Observer)</h2>
<h3 id="의도-6" tabindex="-1"><a class="header-anchor" href="#의도-6" aria-hidden="true">#</a> 의도</h3>
<p>객체 사이에 일대 다의 의존 관계를 정의해두어,
어떤 객체의 상태가 변할 때 그 객체에 의존성을 가진 다른 객체들이 그 변화를 통지 받고 자동으로 갱신될 수 있게 만듭니다.</p>
<h3 id="활용성-6" tabindex="-1"><a class="header-anchor" href="#활용성-6" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>어떤 추상 개념이 두 가지 양상을 갖고 하나가 다른 하나에 종속적일 때. 각 양상을 별도의 객체로 캡슐화하여 이들 각각을 재사용할 수 있습니다.</li>
<li>한 객체에 가해진 변경으로 다른 객체를 변경해야 하고, 프로그래머들은 얼마나 많은 객체들이 변경되어야 하는지 몰라도 될 때</li>
<li>어떤 객체가 다른 객체에 자신의 변화를 통보할 수 있는 데, 그 변화에 관심있어 하는 객체들이 누구인지에 대한 가정 없이도 그러한 통보가 될 때</li>
</ul>
<h3 id="구조-및-구현-6" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-6" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Observer</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="상태-state" tabindex="-1"><a class="header-anchor" href="#상태-state" aria-hidden="true">#</a> 상태(State)</h2>
<h3 id="의도-7" tabindex="-1"><a class="header-anchor" href="#의도-7" aria-hidden="true">#</a> 의도</h3>
<p>객체의 내부 상태에 따라 스스로 행동을 변경할 수 있게끔 허가하는 패턴으로, 이렇게 하면 객체를 마치 자신의 클래스를 바꾸는 것 처럼 보인다.</p>
<h3 id="활용성-7" tabindex="-1"><a class="header-anchor" href="#활용성-7" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>객체의 행동이 상태에 따라 달라질수 있고, 객체의 상태에 따라서 런타임에 행동이 바뀌어야 할 때</li>
<li>어떤 연산에 그 객체의 상태에 따라 달라지는 다중 분기 조건 처리가 너무 많이 있을 때</li>
</ul>
<h3 id="구조-및-구현-7" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-7" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">State</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="전략-strategy" tabindex="-1"><a class="header-anchor" href="#전략-strategy" aria-hidden="true">#</a> 전략(Strategy)</h2>
<h3 id="의도-8" tabindex="-1"><a class="header-anchor" href="#의도-8" aria-hidden="true">#</a> 의도</h3>
<p>동일 계열의 알고리즘군을 정의하고, 각각의 알고리즘을 캡슐화하여, 이들을 상호교환이 가능하도록 만드는 패턴이다.
알고리즘을 사용하는 사용자와 상관없이 독립적으로 알고리즘을 다양하게 변경할 수 있게 한다.</p>
<h3 id="활용성-8" tabindex="-1"><a class="header-anchor" href="#활용성-8" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>하나의 클래스가 많은 행동을 정의하고, 이런 행동들이 그 클래스의 연산안에서 복잡한 다중 조건문의 모습을 취할 때</li>
<li>행동들이 조금씩 다를 뿐 개념적으로 관련된 많은 클래스들이 존재할 때</li>
<li>알고리즘의 변형이 필요할 때</li>
<li>사용자가 몰라야 하는 데이터를 사용하는 알고리즘이 있을 때</li>
</ul>
<h3 id="구조-및-구현-8" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-8" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Strategy</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="탬플릿-메소드-template-method" tabindex="-1"><a class="header-anchor" href="#탬플릿-메소드-template-method" aria-hidden="true">#</a> 탬플릿 메소드(Template Method)</h2>
<h3 id="의도-9" tabindex="-1"><a class="header-anchor" href="#의도-9" aria-hidden="true">#</a> 의도</h3>
<p>객체의 연산에는 알고리즘의 뼈대만을 정의하고 각 단계에서 수행할 구체적 처리는 서브클래스쪽으로 미루는 패턴이다. 알고리즘의 구조 자체는 그대로 놔둔 채 알고리즘 각 단계의 처리를 서브클래스에서 재정의할 수 있게 한다.</p>
<h3 id="활용성-9" tabindex="-1"><a class="header-anchor" href="#활용성-9" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>어떤 한 알고리즘을 이루는 부분 중 변하지 않는 부분을 한 번 정의해 놓고 다양해질 수 있는 부분은 서브클래스에서 정의할 수 있도록 남겨두고자 할 때</li>
<li>서브클래스 사이의 공통적인 행동을 추출하여 하나의 공통 클래스에 몰아둠으로써 코드 중복을 피하고 싶을 때</li>
<li>서브클래스의 확장을 제어할 수 있습니다. 템플릿 메서드가 어떤 특정한 시점에 '훅' 연산을 호출하도록 정의함으로써, 그 특정 시점에서만 확장되도록 합니다.</li>
</ul>
<h3 id="구조-및-구현-9" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-9" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">AbstractClass</span> <span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="방문자-visitor" tabindex="-1"><a class="header-anchor" href="#방문자-visitor" aria-hidden="true">#</a> 방문자(Visitor)</h2>
<h3 id="의도-10" tabindex="-1"><a class="header-anchor" href="#의도-10" aria-hidden="true">#</a> 의도</h3>
<p>객체 구조를 이루는 원소에 대해 수행할 연산을 표현하는 패턴으로, 연산을 적용할 원소의 클래스를 변경하지 않고도 새로운 연산을 정의할 수 있게 한다.</p>
<h3 id="활용성-10" tabindex="-1"><a class="header-anchor" href="#활용성-10" aria-hidden="true">#</a> 활용성</h3>
<ul>
<li>객체 구조를 정의한 클래스는 거의 변하지 않지만, 전체 구조에 걸쳐 새로운 연산을 추가하고 싶을</li>
</ul>
<h3 id="구조-및-구현-10" tabindex="-1"><a class="header-anchor" href="#구조-및-구현-10" aria-hidden="true">#</a> 구조 및 구현</h3>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">ElementClass</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">ConcreteVisitor</span> <span class="token keyword">implements</span> <span class="token class-name">Visitor</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="사용자측-코드-8" tabindex="-1"><a class="header-anchor" href="#사용자측-코드-8" aria-hidden="true">#</a> 사용자측 코드</h4>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
