<template><div><h1 id="명령형-프로그래밍-사고로-전환하기" tabindex="-1"><a class="header-anchor" href="#명령형-프로그래밍-사고로-전환하기" aria-hidden="true">#</a> 명령형 프로그래밍 사고로 전환하기</h1>
<h2 id="명령형과-함수형-비교" tabindex="-1"><a class="header-anchor" href="#명령형과-함수형-비교" aria-hidden="true">#</a> 명령형과 함수형 비교</h2>
<h3 id="두-리스트-연결로-비교" tabindex="-1"><a class="header-anchor" href="#두-리스트-연결로-비교" aria-hidden="true">#</a> 두 리스트 연결로 비교</h3>
<blockquote>
<p>순수 함수형 데이터 구조 도서</p>
</blockquote>
<h4 id="명령형" tabindex="-1"><a class="header-anchor" href="#명령형" aria-hidden="true">#</a> 명령형</h4>
<p>명령형 방식에서는 리스트의 첫 셀과 마지막 셀에 대한 포인터를 유지함으로써 O(1)만에 두 리스트를 이어 붙일 수 있다. 첫 번째 리스트의 마지막 셀이 두 번째 리스트의 첫 번째 셀을 가리키도록 변경함으로써 쉽게 구현할 수 있다. 단 두 리스트를 모두 파괴한다는 점에 유의해야 한다. 두 리스트를 이어 붙인 뒤 두 리스트를 재사용할 수 없다.</p>
<h4 id="함수형" tabindex="-1"><a class="header-anchor" href="#함수형" aria-hidden="true">#</a> 함수형</h4>
<p>함수형 방식에서는 첫 번째 리스트의 마지막 셀을 이런 식으로 변경할 수 없다. 대신 우리가 마지막 셀을 복사하면서, 복사본에서 다음 셀을 가리키는 포인터가 두 번째 리스트의 첫 셀을 가리키게 만든다. 그런 다음, 끝에서 두 번째 셀을 복사하면서 꼬리 포인터가 방금 생긴 마지막 셀의 복사본을 가리키게 한다. 이런 과정을 첫 번째 리스트를 모두 다 복사할 때까지 반복한다. 이 경우 영속성이 생겨나는 대신 복사에 O(n)이라는 추가 비용이 든다.</p>
<h3 id="에러-처리-비교" tabindex="-1"><a class="header-anchor" href="#에러-처리-비교" aria-hidden="true">#</a> 에러 처리 비교</h3>
<h4 id="명령형-1" tabindex="-1"><a class="header-anchor" href="#명령형-1" aria-hidden="true">#</a> 명령형</h4>
<p><strong>명령형</strong> 코드에서 예외를 붙잡아 던지는 방법은 try-catch 에러 처리가 있다. 예외를 던질 가능성이 있는 것들을 try를 감싸고 예외를 발생하면 catch에서 처리하는 것이다. 반환값으로 실패 전달의 단점을 해결하여 원래하고 싶은 것을 기술한 코드와 실패했을 때의 처리를 분리할 수 있다.</p>
<h4 id="함수형-1" tabindex="-1"><a class="header-anchor" href="#함수형-1" aria-hidden="true">#</a> 함수형</h4>
<p>함수형 관점에서 try-catch 에러 처리는 다음과 같은 특징을 띈다.</p>
<ul>
...
<p><strong>함수형</strong> 에러 처리는 철저히 다른 방법으로 접근해 소프트웨어 시스템의 난관을 해결합니다. 기본 아이디어는 비슷합니다. 잠재적으로 위험한 코드 주위에 안전망(말하자면 컨테이너)을 설치하는 것입니다.</p>
<p>함수형 프로그램에서는 위함한 코드를 감싼다는 개념은 그대로 가져가되 try-catch 블록은 제거할 수 있습니다. 이것이 명령형과 가장 큰 차이점입니다. 함수형 자료형을 사용하여 불순함과의 분리를 일급 시민으로 만드는 것이지요.</p>
<h3 id="반복-처리-비교" tabindex="-1"><a class="header-anchor" href="#반복-처리-비교" aria-hidden="true">#</a> 반복 처리 비교</h3>
<p><strong>명령형 프로그래밍</strong>은 작업 수행에 필요한 전 단계를 노출하여 흐름이나 경로를 아주 자세히 서술한다. 보통 작업을 수행하는 단계는 루프와 분기문, 구문마다 값이 바뀌는 변수들로 빼곡히 들어찬다.</p>
<p><strong>함수형 프로그래밍</strong>은 독립적인 블랙박스 연산들이 단순하게, 즉 최소한의 제어 구조를 통해 연결되어 추상화 수준이 높다. 실제로 함수형 프로그램은 데이터와 제어 흐름 자체를 고수준 컴포넌트 사이의 단순한 연결로 취급한다.</p>
<h4 id="_1-30세-이상인-users를-거른다" tabindex="-1"><a class="header-anchor" href="#_1-30세-이상인-users를-거른다" aria-hidden="true">#</a> 1. 30세 이상인 users를 거른다.</h4>
<CodeTabs id="76" :data='[{"id":"명령형"},{"id":"함수형"}]' tab-id="js">
<template #title0="{ value, isActive }">명령형</template>
<template #title1="{ value, isActive }">함수형</template>
<template #tab0="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> temp_users <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> over_30 <span class="token operator">=</span> users<span class="token punctuation">.</span><span class="token function">filter</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span>age<span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token operator">=></span> age <span class="token operator">>=</span> <span class="token number">30</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></template>
</CodeTabs>
<h4 id="_2-30세-이상인-users의-names를-수집한다" tabindex="-1"><a class="header-anchor" href="#_2-30세-이상인-users의-names를-수집한다" aria-hidden="true">#</a> 2. 30세 이상인 users의 names를 수집한다.</h4>
<CodeTabs id="87" :data='[{"id":"명령형"},{"id":"함수형"}]' tab-id="js">
<template #title0="{ value, isActive }">명령형</template>
<template #title1="{ value, isActive }">함수형</template>
<template #tab0="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> names <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<h4 id="_3-30세-미만인-users를-거른다" tabindex="-1"><a class="header-anchor" href="#_3-30세-미만인-users를-거른다" aria-hidden="true">#</a> 3. 30세 미만인 users를 거른다.</h4>
<CodeTabs id="98" :data='[{"id":"명령형"},{"id":"함수형"}]' tab-id="js">
<template #title0="{ value, isActive }">명령형</template>
<template #title1="{ value, isActive }">함수형</template>
<template #tab0="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> temp_users2 <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
<span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">let</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> users<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>users<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">.</span>age <span class="token operator">&lt;</span> <span class="token number">30</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<template #tab1="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> under_30 <span class="token operator">=</span> users<span class="token punctuation">.</span><span class="token function">filter</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span>age<span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token operator">=></span> age <span class="token operator">&lt;</span> <span class="token number">30</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></template>
</CodeTabs>
<h4 id="_4-30세-미만인-users의-ages를-수집한다" tabindex="-1"><a class="header-anchor" href="#_4-30세-미만인-users의-ages를-수집한다" aria-hidden="true">#</a> 4. 30세 미만인 users의 ages를 수집한다.</h4>
<CodeTabs id="109" :data='[{"id":"명령형"},{"id":"함수형"}]' tab-id="js">
<template #title0="{ value, isActive }">명령형</template>
<template #title1="{ value, isActive }">함수형</template>
<template #tab0="{ value, isActive }">
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> ages <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
<h2 id="명령형-객체지향-함수형-패러다임-구분하기" tabindex="-1"><a class="header-anchor" href="#명령형-객체지향-함수형-패러다임-구분하기" aria-hidden="true">#</a> 명령형/객체지향/함수형 패러다임 구분하기</h2>
<h3 id="명령형-2" tabindex="-1"><a class="header-anchor" href="#명령형-2" aria-hidden="true">#</a> 명령형</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="객체지향" tabindex="-1"><a class="header-anchor" href="#객체지향" aria-hidden="true">#</a> 객체지향</h3>
<p>다음으로 객체지향은 상태와 행동을 지닌 자율적인 객체에 역할과 책임을 부여하고 다른 객체들과 협력하여 시스템을 구성합니다.</p>
...
<span class="token keyword">class</span> <span class="token class-name">TodoItem</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="함수형-2" tabindex="-1"><a class="header-anchor" href="#함수형-2" aria-hidden="true">#</a> 함수형</h3>
<p>마지막으로 함수형은 가변(可變) 상태를 멀리하고 불변(不變) 상태를 추구합니다. 가변 상태는 조작의 타이밍이나 순서에 따라 예상과 다르게 동작할 위험이 있으므로 불변 상태를 추구합니다.</p>
...
<span class="token keyword">class</span> <span class="token class-name">TodoItem</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="끝" tabindex="-1"><a class="header-anchor" href="#끝" aria-hidden="true">#</a> 끝</h2>
</div></template>
